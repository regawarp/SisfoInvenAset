...
if (isset($_SESSION['user_id'])) {
    ...
    $sql = "SELECT * FROM ded,dedlokasi,lokasi WHERE ded.ID_DED='$_GET[ID_DED]' AND ded.ID_DED=dedlokasi.ID_DED AND dedlokasi.ID_LOKASI=lokasi.ID_LOKASI";
    $result = mysqli_query($conn, $sql);
    if ($row = mysqli_fetch_assoc($result)) { } else {
        header("Location: ded_home.php");
    }
} else {
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Update DED</h4>
                                    <form class="form-sample" action="../process.php?process=update-ded" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row"> <label class="col-sm-3 col-form-label">ID_DED</label>
                                                    <div class="col-sm-9">
                                                        <input type='text' class='form-control' name='ID_DED' readonly <?php echo"value='$row[ID_DED]'";?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
