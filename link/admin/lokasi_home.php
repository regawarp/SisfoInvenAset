												...
												if (mysqli_num_rows($result) > 0) {
													while ($row = mysqli_fetch_assoc($result)) {
														echo "<tr>
																...
																<td><a href='lokasi_update.php?ID_LOKASI=$row[ID_LOKASI]'><button class='btn btn-warning' type='button'>
																<span class='mdi mdi-pencil'></span>
																</button></a></td>
																<td><a href='../process.php?process=delete-lokasi&&ID_LOKASI=$row[ID_LOKASI]'><button class='btn btn-danger' type='button'>
