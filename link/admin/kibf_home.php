						...
						<div class="col-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<a href="kibf_export.php" class="btn btn-success col-md-12"style="margin-top:20px;">
														...
														<div class="col-sm-9">
															...
															if (mysqli_num_rows($result) > 0) {
																if ($id = mysqli_fetch_assoc($result)) {
																	$num = $id['ID_KIBF'];
																	$num++;
																	echo "<input type='text' class='form-control' name='ID_KIBF' value='$num' readonly/>";
																} else {
																	echo "<input type='text' class='form-control' name='ID_KIBF' value='1'/> readonly";
																}
															}
															?>
														</div>
