...
if (isset($_SESSION['user_id'])) {
    ...
    if ($row = mysqli_fetch_assoc($result)) { } else {
        header("Location:lokasi_home.php");
    }
} else {
                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" action="../process.php?process=update-lokasi" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row"> <label class="col-sm-3 col-form-label">ID_LOKASI</label>
                                                    <div class="col-sm-9">
                                                        <input type='text' class='form-control' name='ID_LOKASI' readonly <?php echo "value='$row[ID_LOKASI]'"; ?>>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row"> <label class="col-sm-3 col-form-label">NAMA LOKASI</label>
                                                    <div class="col-sm-9"> <input type="text" class="form-control" name="NAMA_LOKASI" <?php echo "value='$row[NAMA_LOKASI]'"; ?>></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
